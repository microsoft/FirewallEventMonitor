...
///
/// Notice all functions are in the ntl::String namespace
///
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
...
namespace ntl {
    ...
    namespace String {
        ...
        ///     auto spaces = ntl::str::all_indices_of(
        ...
        ///
        /// Can throw ntl::Exception on failures from the underlying conversion calls
        ...
        std::string convert_to_string(const std::wstring& _wstr)
        {
            ...
            if (len == 0) {
                throw ntl::Exception(::GetLastError(), L"::WideCharToMultiByte", L"ntl::String::convert_to_string", false);
            }
        ...
        std::wstring convert_to_wstring(const std::string& _str)
        {
            ...
            if (len == 0) {
                throw ntl::Exception(::GetLastError(), L"::MultiByteToWideChar", L"ntl::String::convert_to_wstring", false);
            }
        ...
        ///
        /// Can throw a ntl::Exception if the Win32 API fails
        ///
        /// Examples:
        ///
        ...
        // These helpers are in a named namespace so that ntl::ComBstr can define its own version in ComInitialize.hpp
        //
        ...
        namespace _detail {
            ...
            inline bool impl_ordinal_equals(
                ...
                const size_t _lhs_size,
                _In_NLS_string_(_rhs_size) const wchar_t* _rhs,
                const size_t _rhs_size,
                const BOOL _case_insensitive)
            {
                switch (::CompareStringOrdinal(
                    ...
                    default:
                        throw ntl::Exception(::GetLastError(), L"CompareStringOrdinal", L"ntl::String::impl_ordinal_equals", false);
                }
            }
...
#pragma region Desktop Family
                ...
                const BOOL _case_insensitive)
            {
                switch (::CompareStringA(
                    ...
                    default:
                        throw ntl::Exception(::GetLastError(), L"CompareString", L"ntl::String::impl_ordinal_equals", false);
                }
            }
#else
            inline
                ...
                const BOOL _case_insensitive)
            {
                ...
                ntl::AlwaysFatalCondition(L"String: cannot compare char* strings in modern apps: CompareStringA is not supported");
            }
...
#pragma prefast(suppress:26018, "OACR doesn't offer a way to annotate the requirement that wcslen(convert_to_ptr(x)) == get_string_length(x)")
            return ::ntl::String::_detail::impl_ordinal_equals(
                ::ntl::String::_detail::convert_to_ptr(_lhs),
                ::ntl::String::_detail::get_string_length(_lhs),
                ::ntl::String::_detail::convert_to_ptr(_rhs),
                ::ntl::String::_detail::get_string_length(_rhs),
                FALSE);
        }
        template <typename LeftStringT, typename RightStringT>
...
#pragma prefast(suppress:26018, "OACR doesn't offer a way to annotate the requirement that wcslen(convert_to_ptr(x)) == get_string_length(x)")
        ...
        ///   with ntl::String::replace_all and ntl::String::replace_all_copy.
        ...
        /// Currently formats std::exception and ntl::Exception instances
        ///
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        inline
        std::wstring format_exception(const ntl::Exception& _exception)
        {
            ...
            return format_string(
                L"[ntl::Exception] %s%s%s%s [%u / 0x%x - %s]",
                what_exists ? L" " : L"",
        ...
        {
            const ntl::Exception* ntEx = dynamic_cast<const ntl::Exception*>(&_exception);
            if (ntEx != nullptr) {
                return format_exception(*ntEx);
            } else {
                return format_string(
                    L"[std::exception] %S",
                    _exception.what());
